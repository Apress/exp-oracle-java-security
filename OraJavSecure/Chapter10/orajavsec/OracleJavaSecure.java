...
public class OracleJavaSecure {
    ...
    public static void main( String[] args ) {
        ...
        try {
            ...
            // You may place 2-Factor auth code here for testing from IDE
            // Remember, it is only good for 10 minutes from creation
            ...
            // Must get conn Hash before put app conn Strings
            getAppConnections();

            // Go no further until we have a 2-Factor Auth Code
            ...
            // If try putAppConnections after getAppAuthConn, will no longer
            // have exchanged keys with APPVER to Oracle (However, can continue
            // to use local copy of APPVER DES key for conn string encrypt / decrypt)
            putAppConnections();

            // Assign an array of connection strings for external client app
            // Not in Oracle
            //putAppConnections( new orajavsec.TestOracleJavaSecure.TInnerRevLvlClass().returnThis(), testHash );
