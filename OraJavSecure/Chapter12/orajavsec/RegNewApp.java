...
/*
 * Test this by :
 * Delete row in apver/appsec.v_application_admins for testojs.TestOracleJavaSecure$AnyNameWeWant
 * Delete row in apver/appsec.v_app_class_id for testojs.TestOracleJavaSecure$AnyNameWeWant
 * Delete row(s) in apver/appsec.v_app_conn_registry for testojs.TestOracleJavaSecure$AnyNameWeWant
 * Delete row(s) in appsec.v_application_registry for HRVIEW on both orcl and apver instances
 * commit on both orcl and apver
        ...
        SwingUtilities.invokeLater(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        // To use this procedure, must grant CREATE PROCEDURE to appsec on apver
                        stmt =
