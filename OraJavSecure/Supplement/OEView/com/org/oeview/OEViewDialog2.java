...
public class OEViewDialog2 extends JDialog {
    JDialog thisComponent = this;
    OEView2 parent;
    ...
    public OEViewDialog2() {
        this(null, "", false);
    }

    public OEViewDialog2(Frame parent, String title, boolean modal) {
        ...
        */
        ...
        SwingUtilities.invokeLater(new Runnable() {
                public void run() {
                    ...
                    try {
                        stmt =
(OracleCallableStatement)parent.conn.prepareCall("CALL oe.oe_sec_pkg.p_update_customers_sensitive(?,?,?,?,?,?,?,?,?,?)");
                        ...
                        stmt.setRAW(6,
                                    OracleJavaSecure.getCryptData(jTextField12.getText()));
                        stmt.setRAW(7,
                        ...
                        if (errNo != 0) {
                            ...
                            JOptionPane.showMessageDialog(thisComponent,
                                                          "Oracle error p_update_customers_sensitive) " +
                                                          errNo + ", " +
                                                          errMsg);
                        }
                    } catch (Exception x) {
